...
doubanMovie_info = pd.read_csv('IMDBallusers34530-37677.csv')  # 取出数据结构为DataFrame的doubanMovies_info
...
for i in range(startPoint - 1, len(IMDBurl)):
    ...
    try:
        ...
        IMDBRate.to_csv('IMDBfinal34530-37677.csv', index=False, encoding='utf-8')
