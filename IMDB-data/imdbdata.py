...
def getDoc(url):
	...
	request = urllib2.Request('http://www.imdb.com'+url, headers=headers)  # 发送请求
...
def getIMDBRate(doc,oneIMDBurl):
    #匹配IMDB评分的xpath路径
    temp=[]
    if doc.xpath('//*[@class="reviews"]/div[1]/h3/a/@href'):
    	temp.append(doc.xpath('//*[@class="reviews"]/div[1]/h3/a/@href')[0])
    if doc.xpath('//*[@class="reviews"]/div[3]/h3/a/@href'):
    	temp.append(doc.xpath('//*[@class="reviews"]/div[3]/h3/a/@href')[0])
    if doc.xpath('//*[@class="reviews"]/div[5]/h3/a/@href'):
    	temp.append(doc.xpath('//*[@class="reviews"]/div[5]/h3/a/@href')[0])
    if doc.xpath('//*[@class="reviews"]/div[7]/h3/a/@href'):
    	temp.append(doc.xpath('//*[@class="reviews"]/div[7]/h3/a/@href')[0])
    if doc.xpath('//*[@class="reviews"]/div[9]/h3/a/@href'):
    	temp.append(doc.xpath('//*[@class="reviews"]/div[9]/h3/a/@href')[0])
    if doc.xpath('//*[@class="reviews"]/div[11]/h3/a/@href'):
    	temp.append(doc.xpath('//*[@class="reviews"]/div[11]/h3/a/@href')[0])
    if doc.xpath('//*[@class="reviews"]/div[13]/h3/a/@href'):
    	temp.append(doc.xpath('//*[@class="reviews"]/div[13]/h3/a/@href')[0])
    if doc.xpath('//*[@class="reviews"]/div[15]/h3/a/@href'):
    	temp.append(doc.xpath('//*[@class="reviews"]/div[15]/h3/a/@href')[0])
    if doc.xpath('//*[@class="reviews"]/div[17]/h3/a/@href'):
    	temp.append(doc.xpath('//*[@class="reviews"]/div[17]/h3/a/@href')[0])
    if doc.xpath('//*[@class="reviews"]/div[19]/h3/a/@href'):
    	temp.append(doc.xpath('//*[@class="reviews"]/div[19]/h3/a/@href')[0])
    print temp
...
for i in range(startPoint-1,len(IMDBurl)):
    ...
    try:
        ...
        IMDBRate.to_csv('IMDBfinal.csv',index=False,encoding='utf-8')